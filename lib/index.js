...
function pluginChatPage(context, options = {}) {
    ...
    // Default options
    const { label = "Chat", path: inputPath = "chat", openai, embeddingCache, prompt, embedding, } = options;
    // Normalize the path
    ...
    return {
        ...
        async loadContent() {
            ...
            return (0, content_1.loadContent)({ ...context, options: { openai, embeddingCache, embedding } });
        },
