...
const STORAGE_KEY = constants_1.STORAGE_KEYS.CHAT_STATE;
...
function ChatPage() {
    ...
    const findRelevantChunks = async (query, topK = constants_1.DEFAULT_EMBEDDING_CONFIG.relevantChunks) => {
        try {
    ...
    const handleSubmit = async (e) => {
        ...
        setInputValue("");
        try {
            const relevantChunks = await findRelevantChunks(inputValue, config.embedding?.relevantChunks || constants_1.DEFAULT_EMBEDDING_CONFIG.relevantChunks);
