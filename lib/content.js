...
function filePathToURL(filePath, baseURL) {
    ...
    // Remove numeric prefixes from path segments (e.g., "1_operate" -> "operate")
    urlPath = urlPath.replace(/\/?\d+_/g, '/');
    // Convert remaining underscores to hyphens for better URLs
    urlPath = urlPath.replace(/_/g, '-');
    // Clean up multiple slashes and leading slash
